...
(()=>{
 ...
 function play(root,plan){cancel();if(!plan||!window.DinoResourceMotion?.enabled())return Promise.resolve();return new Promise(resolve=>{
  ...
  try{
   const e=plan.effect,E=window.DinoEngine,c=E.COMBAT[e.card],a=plan.art;
